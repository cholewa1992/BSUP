...
\begin{enumerate}
	...
	\item 	Hvilke dele af projektet kunne være blevet gjort bedre for at opnå et bedre resultat?
\end{enumerate}
...
For at svare på problemformuleringen vil der blive kigget på forskellige metoder til at estimere, planlægge og udføre aktiviteter i target-projektet. I target-projektet anvendes Delphi-metoden til at estimere aktiviteter med, en simplificerert version af SCRUM (SCRUM-but) som procesmodel og et Gantt kort til planlægning af aktiviteter. Derudover bliver der sideløbende afprøvet alternative metoder som kan sammenlignes med de metoder der faktisk bliver brugt i projektet. Dette vil inkludere Function Points til estimering af aktiviteter, vandfaldsmodellen og spiralmodellen som procesmodeller og The Precendence Network til at planlægge aktiviteter. 
